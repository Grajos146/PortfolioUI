  ...
  return (
    <section id="contact" className="relative  w-full overflow-hidden px-5 py-16 sm:py-24 md:px-10 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 mx-auto max-w-7xl">
        ...
        <span className="uppercase font-black fraunces text-5xl sm:text-6xl md:text-[5rem]">Let's</span>
        <span className="uppercase font-black fraunces text-5xl sm:text-6xl md:text-[5rem] [-webkit-text-stroke:2px_indigo] text-transparent">Build</span>
        <span className="uppercase font-black fraunces text-5xl sm:text-6xl md:text-[5rem]">Together</span>
